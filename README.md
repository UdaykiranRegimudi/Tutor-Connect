# Daytona Project: Tutor-Connect

This project is built using [Daytona](https://daytona.dev), a modern development toolchain designed for speed and simplicity.
...
- Ensure you have [Daytona](https://daytona.dev) installed. Follow the [Daytona installation guide](https://daytona.dev/docs/getting-started).
...
1. **Create the Workspace**  
   ...
   ```bash
   daytona create https://github.com/UdaykiranRegimudi/Tutor-Connect
...
<h3>Contributors:</h3>
  ...
  -  Google OAuth | Admin CRUD backend | Authentication
  - Backend Logic for Login | Signup | Student Booking
  -  Implemented the whole front-end in React using function based components
